...
| Workspace pages | `.workspace-page`, `.workspace-panel`, `.workspace-header`, `.workspace-feedback`, `.projects-page`, `.projects-search`, `.project-card`, `.project-detail`, `.project-chat-item`, `.project-form-modal`, `.project-add-chats-modal`, `.project-add-chat-item`, `.memory-panel`, `.memory-list`, `.memory-item` | Shared settings/projects page structure, project grid/detail views, memory controls, and app-modal project forms/add-chat workflow. |
